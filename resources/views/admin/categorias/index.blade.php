            ...
            <div class="card">
                <div class="card-header">
                    <h4>Categorias registradas
                        <a href="{{ url('admin/categorias/create') }}" style="float:right" class="btn btn-primary"><i class="bi bi-plus"></i> Crear Nueva</a>
                    </h4>
                </div>
                <div class="card-body">
                    <div class="row">
                            ...
                            @foreach ($categorias as $categoria)
                                <tr>
                                    ...
                                    <td class="text-center" style="white-space: nowrap;">
                                        <a href="{{ url('/admin/categoria/' .$categoria->id) }}" class="btn btn-sm btn-info me-1"><i class="bi bi-eye"></i> Ver</a>
                                        <a href="{{ url('/admin/categorias/' .$categoria->id . '/edit') }}" class="btn btn-sm btn-success me-1"><i class="bi bi-pencil"></i> Editar</a>
                                        <form action="{{ url('/admin/categorias/' .$categoria->id) }}" method="POST" id="miFormulario{{ $categoria->id }}" style="display: inline;">
                                            @csrf
                                            @method('DELETE')

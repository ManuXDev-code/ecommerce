            ...
            <div class="card">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form action="{{url('/admin/producto/'.$producto->id.'/upload_imagenes')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                    ...
                    <div class="col-md-3" style="margin-bottom: 20px;">
                        <div class="card">
                            <img src="{{ asset('storage/' . $imagen->imagen) }}" class="card-img-top"
                                ...
                                <form action="{{ url('/admin/producto/imagen/' . $imagen->id . '/destroy_imagenes') }}" method="post"

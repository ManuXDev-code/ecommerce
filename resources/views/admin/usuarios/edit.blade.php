                       ...
                       <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control" value="{{ old('name', $usuario->name) }}" placeholder="Nombre completo" required>
                            </div>
                            @error('name')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="email" id="email" class="form-control" value="{{ old('email', $usuario->email) }}" placeholder="ejemplo@correo.com" required>
                            </div>
                            @error('email')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror

        ...
        <div class="hero-container">
            <div class="hero-content">
                <div class="content-wrapper" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="hero-description">Descubre nuestra selección seleccionada de artículos premium diseñados para
                        mejorar tu estilo de vida. Desde moda hasta tecnología, encuentra todo lo que necesitas con ofertas
                        exclusivas y envíos rápidos.</p>
                        ...
                        <div class="product-item">
                            <div class="product-image">
                                ...
                                <div class="product-actions">
                                    ...
                                    <a href="{{ url('/producto/' . $producto->id) }}" class="action-btn view-btn">

          ...
          <div class="col-lg-10">
            <div class="registration-form-wrapper">
              <div class="form-header text-center">
                ...
                <p>Crea tu empresa y empieza a comprar on nosotros</p>
              </div>
                ...
                <div class="col-lg-8 mx-auto">
                  <form action="{{url('/web/registro')}}" method="post">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-6">
                        <div class="form-floating">
                          <input type="password" class="form-control" id="confirmPassword" name="password_confirmation" placeholder="Confirm Password" required="" minlength="8" autocomplete="new-password">
                    ...
                    <div class="login-link text-center">
                      <p>Ya tienes una cuenta? <a href="{{url('/web/login')}}">Iniciar Sesion</a></p>
                    </div>
                  </form>
                </div>
              </div>
